...
3. 如果用户查询高铁火车票信息, 按照以下步骤处理
    - 需要 GetStationCodeByName 查询对应的车站 code, 如果返回code 为空，那么需要从 StationNamesJson 中找出目的地相关的车站对应 code，例如目的地是 “杭州”，GetStationCodeByName 找不到对应 code，但是 StationNamesJson 有 “杭州东”，那么使用 “杭州东”
